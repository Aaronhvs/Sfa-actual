...
class OpenAICompatibleRankingExplanationWriter:
    ...
    async def write(
        ...
        prompt = (
            ...
            "Debes escribir TODO en espanol natural. No uses ingles futbolero: di Mundial, "
            "dieciseisavos, eliminatorias, marcador, fase, rival, puntos por partido. "
            "Tu trabajo no es repetir la tabla: debes defender una tesis clara sobre por que "
            "el ranking tiene sentido futbolisticamente usando solo el JSON de evidencia. "
            "Usa methodology.product_thesis como idea central cuando ayude: SFA no mide solo "
            "cuanto juega alguien; mide cuanto pesa cuando juega. "
            ...
            "Aplica methodology.positional_lens: no valores igual una participacion de gol de un defensa "
            "que la de un delantero; si un central o lateral suma goles/asistencias, recalcalo como rareza valiosa. "
            "Si un mediocampista domina con precision de pase o pases clave, explicalo como control del juego. "
            "Si un atacante tiene pocos tiros pero alta conversion o muchos tiros a puerta, explicalo como eficiencia. "
            "Usa comparison.top_peers y best_points_per_match para explicar si supera a jugadores "
            "con mas partidos por eficiencia/impacto por partido. "
            "Usa match_summaries para hablar de su mejor noche. En cada top_action e impact_minutes "
            "puedes usar score_context, m1_context y m3_context para explicar si una accion llego "
            "cuando perdia, empataba o ganaba, y si el rival/momento le resto o le sumo. "
            "Si tiene bonus de edad/promesa, aclara si el rendimiento base seguiria siendo fuerte "
            "sin convertir el bonus en la unica razon. "
            "No inventes datos, records historicos, rivales ni marcadores no presentes en la evidencia. "
            "Evita frases genericas como 'el motor pondera rival, fase y minuto'. Si mencionas el motor, "
            "debes asociarlo a una accion concreta, por ejemplo: gol al minuto X con el partido empatado, "
            "rival inferior que castigo M1, o momento clave que elevo M3. "
            ...
            "long_text debe tener 2 o 3 parrafos breves: primero plantea la tesis, luego prueba "
            "con partidos/multiplicadores/bonos concretos. "
