...
class OpenAICompatibleRankingExplanationWriter:
    ...
    async def write(
        ...
        prompt = (
            ...
            "Tesis editorial base: SFA no mide solo cuanto juega alguien; mide cuanto pesa "
            "cuando juega. "
            ...
            "Usa match_summaries para hablar de su mejor noche y, si top_action trae M1/M2/M3/Mvisit, "
            "explica que le resto o que le sumo en ese caso concreto. "
