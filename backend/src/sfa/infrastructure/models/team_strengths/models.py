...
class TeamStrength(Base):
    ...
    elo_seed_raw: Mapped[float | None] = mapped_column(Numeric(7, 2), nullable=True)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "source IN ('calculated', 'default', 'override', 'clubelo_seed', "
            "'elo_v1', 'club_elo_v2', 'national_elo_seed', 'national_elo_v1')",
