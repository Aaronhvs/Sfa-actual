...
- [x] Commit and deploy API/worker with Beat paused.
- [x] Apply migration 0050 and verify the single UEFA Super Cup final row is `1.30`.
- [x] Reingest fixture external id `1552735` with forced detail refresh.
- [x] Replay season-2026 club ELO and scoring once.
- [x] Verify zero event-side inconsistencies and audit PSG/Rennes calculation details.
- [x] Restart Beat and confirm worker health.
